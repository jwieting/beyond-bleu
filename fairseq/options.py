...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--reset-epochs', action='store_true',
                       help='reset epoch counter to 1')
    return group
...
def add_sequence_training_args(parser):
    ...
    group.add_argument('--seq-score-alpha', type=float, default=1., metavar='D',
                       help='trade-off between BLEU and SIM.')
    group.add_argument('--sim-model-file', default="data_and_models/sim/sim.pt", type=str,
                       help='model file for SIM.')
    group.add_argument('--length-penalty', type=float, default=0.25, metavar='D',
